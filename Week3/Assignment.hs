...
cnf2cls (Prop x) = [ [x] ] -- base clause, just one property.    Amir: seems legit. How would the Neg(Prop x) work do you think?   I thouht initially: cnf2cls (Neg y) = Neg (cnf2cls y).
